...
Terra has full IBC transfer capabilities through both feather.js and Station. Although IBC functionality is not readily exposed through Station’s front end, it can be fully incorporated into any dApp. It is up to a dApp’s front end to initiate IBC transfers.
...
Instructions for initializing LCDClient can be found [here](https://terradocs.money//docs/develop/sdks/feather-js/common-examples.html#configuring-lcdclient).
